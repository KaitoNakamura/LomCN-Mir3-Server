...
function DecodeMessage(Str: string): TDefaultMessage;
var
  EncBuf: array[0..MIR3_DEFAULT_BLOCK_SIZE - 1] of Char;
  Msg: TDefaultMessage;
begin
...
function EncodeMessage(sMsg: TDefaultMessage): string;
var
  EncBuf, TempBuf: array[0..MIR3_DEFAULT_BLOCK_SIZE - 1] of Char;
begin
...
var
  EncBuf, TempBuf: array[0..MIR3_DEFAULT_BLOCK_SIZE - 1] of Char;
begin
  if bufsize < MIR3_DEFAULT_BLOCK_SIZE then begin
